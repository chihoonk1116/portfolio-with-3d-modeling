...
const Works = () => {
  ...
  const text= `Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia, veritatis.`
      ...
      <div className="relative flex flex-col font-light" onMouseMove={handleMouseMove}>
        {projects.map((project, index) => (
          ...
          > 
            ...
            />
            {/* title */}
            <div className="flex justify-between px-10 text-black transition-all duration-500 md:group-hover:p-6 md:group-hover:text-white">
